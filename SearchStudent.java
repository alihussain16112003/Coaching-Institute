...
public class SearchStudent extends JFrame implements ActionListener
{
	...
	public void ShowSearch()
	{
		...
		j1.setTitle(" Student Data Found ");
		...
		L10.setBounds(160,590,100,30);
		L10.setFont(new Font("Arial",Font.PLAIN,17));
		
		T10 = new JLabel();
		T10.setBounds(330,590,200,30);
		T10.setFont(f);
		j1.add(L10); 		j1.add(T10);
		
		B = new Button("CLOSE");
		B.setBackground(Color.DARK_GRAY);
		B.setForeground(Color.WHITE);
		B.setBounds(190,680,180,30);
			...
			try
			{
				...
				ResultSet rsobj = sobj.executeQuery("select * from Student where Id= "+ch.getSelectedItem()+";");
					...
					while(rsobj.next())
					{
						...
						T8.setText(rsobj.getString(8));
						T9.setText(rsobj.getString(9));
						T10.setText(rsobj.getString(10));
					}
					rsobj.close();
					sobj.close();
					Cobj.close();
