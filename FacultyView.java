...
public class FacultyView extends JFrame implements ActionListener
{
	...
	public FacultyView()
	{
		...
		try
		{
			...
			rsobj = sobj.executeQuery("Select * from Faculty");
			...
			String id,FName,LName,Gender,Specialization,ContactNo;
			...
			while(rsobj.next()){
				...
				Specialization = rsobj.getString(5);
				ContactNo = rsobj.getString(6);
				
	
				String[] row = {id,FName,LName,Gender,Specialization,ContactNo};
				model.addRow(row);
			}	
